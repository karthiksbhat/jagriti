    ...
    <a href="contactus.html"><div class="col-md-2">Contact Us</div></a>
      ...
      <div class="row" >
        <div class="jumbotron soft-shadow">
         ...
         <div class="accent">
<<<<<<< HEAD
          <a href="child_rights_101.html">Click here</a> for an outline of Child Rights.<br/><br/><br/>
=======
...
>>>>>>> d18485c91c77046eb2e3dbe332ae54b497d3dbcc
        ...
        <iframe width="853" height="480" src="//www.youtube.com/embed/4I343z-dksA?rel=0" frameborder="0" allowfullscreen></iframe>
         ...
         <!--<h3 class="big" style="margin-left:27%;">
          Download the <b>Android APK</b> <a href="php/counter.php" target="_blank">here</a> <br/><br/><br/>
         </h3>-->
         <!--<a href="downloads/Jagrit-Bachpan.apk"><img src="img/apkDownload.jpg" width=337px height=100px style="margin-left:34.7%;"><br/><br/><br/></a>-->
         <img src="img/windows_icon.png" style="margin-right:2%;margin-left:2%;">
         <a href="php/counter.php" target="_blank"><img src="img/play_store_online.png" style="margin-right:2%;"></a>
         <img src="img/App_Store_icon.png">
        <br/><br/><br/><br/>
